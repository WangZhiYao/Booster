...
import com.yizhenwind.booster.character.databinding.FragmentCreateCharacterBinding
...
class CreateCharacterFragment :
    BaseMVIFragment<FragmentCreateCharacterBinding, CreateCharacterViewState, CreateCharacterSideEffect, CreateCharacterViewModel>(FragmentCreateCharacterBinding::inflate) {

    override val viewModel: CreateCharacterViewModel by viewModels()
    private val args by fragmentArgs(CreateCharacterArgs::deserialize)
    ...
    override fun render(state: CreateCharacterViewState) {
        when (state) {
            is CreateCharacterViewState.Init -> {
                state.apply {
                    customerList.let {
                        customerAdapter = CustomerAdapter(requireContext(), it)
                        val customer =
